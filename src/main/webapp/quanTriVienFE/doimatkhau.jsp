...
%>
	<div class="container">
		<form action="../quanTriVienController" method="post">
			...
			<a class="btn btn-primary" style="white-space: nowrap;" href= "<%=url %>/quanTriVienFE/trangchu.jsp" >Quay lại trang chủ</a>
