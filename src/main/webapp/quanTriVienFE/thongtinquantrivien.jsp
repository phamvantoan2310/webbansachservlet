...
<body>
	...
	<%
	    	...
	    	String hoVaTen = qtv.getTen();
	    	String gioiTinh = qtv.getGioitinh();
	    	Date ngaySinh = qtv.getNgaysinh();
	    	String diaChi = qtv.getDiachi();
	    	String soDienThoai = qtv.getSdt();
	    	String mail = qtv.getEmail();
 	%>
		...
		<form class="form" action="<%=url %>/quanTriVienController" method="post">
