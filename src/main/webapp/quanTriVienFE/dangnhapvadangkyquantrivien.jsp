...
<body>
	<main class="form-signin w-100 m-auto">
		<form class="text-center" action="<%=url %>/quanTriVienController" method="POST">
		    <input type="hidden" name = "controller" value="dangnhap" id="controller"/>
			...
			<div class="form-floating">
				<input type="password" class="form-control" id="matKhau"
					placeholder="Mật khẩu" name="matKhau" required="required"> <label for="matKhau">Mật khẩu</label>
			</div>
			...
			<a href="dangkyquantrivien.jsp">Đăng ký tài khoản mới</a>
